   ...
   <div className="max-w-7xl mx-auto flex flex-wrap items-center gap-6 w-full">
      ...
      <div id="collapseMenu" tabIndex={-1}
         ...
         <ul
            ...
            <li>
               <a href="#"
                  className="hover:text-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded">How
                  it works</a>
            </li>
            <li>
               <a href="#"
            ...
            <li>
               <a href="#"
                  className="hover:text-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded">Integrations</a>
            </li>
            <li>
               <a href="#"
                  className="hover:text-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded">FAQs</a>
            </li>
         </ul>
      </div>
      ...
      <div className="flex items-center gap-4 ml-auto">
         <a href="#"
            ...
            in</a>
         <a href="#"
            className="py-2 px-3.5 text-sm rounded-md font-semibold cursor-pointer tracking-wide text-white border border-blue-600 bg-blue-600 hover:bg-blue-700 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">Sign
            up</a>
